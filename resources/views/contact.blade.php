...
@section('title', 'Nous contacter - TEM')
...
@section('content')
    <section id="content" class="s-content">
        ...
        <section class="s-pagecontent pagecontent">
            ...
            <div class="row width-narrower pagemain pt-28">
                <div class="column xl-12 lg-12">
                    ...
                    <div class="row">
                        <div class="column xl-6 md-12 contact-cta">
                            <p>
                                Notre projet vous intéresse ? Vous avez des questions ou des suggestions ? Ou vous
                                souhaitez nous rejoindre ?
                                N'hésitez pas à nous contacter par mail
                            </p>

                            <a href="mailto:contac@tem-asso.com" class="btn btn--primary u-fullwidth contact-btn">
                        ...
                        <div class="contact-block">
                            <h6>Email</h6>
                            <a href="mailto:contact@tem-asso.com">contact@tem-asso.com</a>
                        </div>
