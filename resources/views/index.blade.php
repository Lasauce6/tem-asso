                ...
                <div class="column lg-12 s-intro__content-inner grid-block">
                    ...
                    <div class="s-intro__content-media">
                        <div class="s-intro__content-media-inner">
                            <img src={{ asset('asset/images/intro-bg.jpg') }} alt="">
                            <div class="lines">
                                <span></span>
                            </div>
                        </div>
        ...
        <section id="about" class="s-about target-section">
            ...
            <div class="row s-about__content width-sixteen-col">
                <div class="column grid-block grid-section-split">
                    ...
                    <img src={{ asset('asset/images/geometric_shape.png') }} alt="" class="s-about__content-imgbg">
                    ...
                    <div class="s-about__content-main grid-section-split__primary">
                        <p class="attention-getter">
                            ...
                            Composée d'une trentaine de musiciens et de bénévoles, l'association TEM a pour objectif de promouvoir la musique pour tous.
                        ...
                        <p class="attention-getter">
                            ...
                            indépendants et des étudiants !
                            Que ce soit des élèves d'IME, de SEGPA et d'ULIS, de Brunoy jusqu'à Angers, TEM est un projet d'inclusion scolaire
